...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('drone10/downward_cam/camera/image', Image, self.image_callback)
        self.status = rospy.Publisher('drone10/flood_status', Int32, queue_size = 10)
    ...
    def callback(self, data):
        ...
        drone10 = data.pose[int(config['index']['drone10'])]
        drone10_vel = data.twist[int(config['index']['drone10'])]
        ...
        if len(targets) != 0:
            ...
            # print("[drone10] target: ", target, "Err: ", (errX, errY))
            ...
            calc_odom = (Vector3(h_vel_scale * (d10_posX-posX), h_vel_scale * (d10_posY-posY), v_vel_scale*(d10_posZ-drone_height)))    
