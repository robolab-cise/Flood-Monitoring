...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('drone15/downward_cam/camera/image', Image, self.image_callback)
        self.status = rospy.Publisher('drone15/flood_status', Int32, queue_size = 10)
    ...
    def callback(self, data):
        ...
        drone15 = data.pose[int(config['index']['drone15'])]
        drone15_vel = data.twist[int(config['index']['drone15'])]
        ...
        if len(targets) != 0:
            ...
            # print("[drone15] target: ", target, "Err: ", (errX, errY))
            ...
            calc_odom = (Vector3(h_vel_scale * (d15_posX-posX), h_vel_scale * (d15_posY-posY), v_vel_scale*(d15_posZ-drone_height)))
