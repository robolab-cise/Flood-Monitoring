...
class Voronoi:
    ...
    def plot_density(self, ax, x, y, norm):
        ...
        # img = (Image.open('/home/robolab/catkin_ws/src/flood_monitor/scripts/flood3_voronoi.png')).resize((size, size))  #(186,246)
        img = Image.open('/home/robolab/catkin_ws/src/flood_monitor/scripts/flood3_voronoi.png')
