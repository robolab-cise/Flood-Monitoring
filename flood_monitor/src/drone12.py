...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('drone12/downward_cam/camera/image', Image, self.image_callback)
        self.status = rospy.Publisher('drone12/flood_status', Int32, queue_size = 10)
        ...
        self.cmd_vel_pub = rospy.Publisher('drone12/cmd_vel',Twist, queue_size=10)
        self.twist = Twist()
    ...
    def callback(self, data):
        ...
        drone12 = data.pose[int(config['index']['drone12'])]
        drone12_vel = data.twist[int(config['index']['drone12'])]
        ...
        if len(targets) != 0:
            ...
            # print("[drone12] target: ", target, "Err: ", (errX, errY))
            ...
            calc_odom = (Vector3(h_vel_scale * (d12_posX-posX), h_vel_scale * (d12_posY-posY), v_vel_scale*(d12_posZ-drone_height)))
